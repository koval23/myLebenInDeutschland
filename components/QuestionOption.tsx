...
type Props = {
  ...
  russianText: string;        // Перевод на русском
  showTranslation: boolean;   // Показывать ли перевод
...
export function QuestionOption({
  ...
  return (
    ...
    <View style={styles.wrapper}>
      ...
      {/* Русский перевод (если showTranslation === true) */}
      {showTranslation && (
        <Text style={styles.russianText}>{russianText}</Text>
      )}
    </View>
    </View>
  );
