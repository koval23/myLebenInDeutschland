...
export const questionsStateDE: QuestionsMap = {
  'baden-wurttemberg': [
      {
        "question_number": 1,
...
export const questionsStateRU: QuestionsMap = {
  'baden-wurttemberg': [
      {
        "question_number": 1,
        "question":
            "Какой герб принадлежит федеральной земле Баден-Вюртемберг?",
      ...
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Баден-Вюртемберге?",
        "options": [
          "Мекленбургское поозерье",
          "Округ Неккар-Оденвальд",
          "Северная Фрисландия",
          "Альтёттинг"
        ],
        "answer": "Округ Неккар-Оденвальд"
      },
      {
        "question_number": 3,
        "question":
            "На сколько лет избирается земельный парламент в Баден-Вюртемберге?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
      ...
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Баден-Вюртемберг?",
        "options": [
          "синий-белый-красный",
          "чёрный-золотой",
          "бело-синий",
        ...
        "answer": "чёрный-золотой"
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Баден-Вюртемберге?",
        "options": [
          "в управлении правопорядка общины",
          "в Центре по защите прав потребителей",
          "в Земельном центре политического просвещения",
          "в церквях"
        ],
        "answer": "в Земельном центре политического просвещения"
      },
      {
        "question_number": 7,
        "question": "Столицей Баден-Вюртемберга является ...",
        "options": ["Гейдельберг", "Штутгарт", "Карлсруэ", "Мангейм"],
        "answer": "Штутгарт"
      },
      {
        "question_number": 8,
        "question": "Какая из указанных земель — Баден-Вюртемберг?",
        "image": "/images/308.png",
        "options": ["1", "2", "3", "4"],
        "answer": "2"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Баден-Вюртемберге?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
        ...
        "answer": "Министр-президент"
      },
      {
        "question_number": 10,
        "question": "Какого министра нет в Баден-Вюртемберге?",
        "options": [
          "Министр финансов",
          "Министр юстиции",
    ...
    'bayern': [
      {
        "question_number": 1,
        "question": "Какой герб принадлежит Свободному государству Бавария?",
        "image": "/images/311.png",
        "options": ["1", "2", "3", "4"],
        "answer": "2"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Баварии?",
        "options": [
          "Приньниц",
          "Райн-Зиг",
          "Северная Фрисландия",
      ...
      {
        "question_number": 3,
        "question": "На сколько лет избирается земельный парламент в Баварии?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
      ...
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Бавария?",
        "options": [
          "синий-белый-красный",
          "бело-синий",
          "зелёный-белый-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Баварии?",
        "options": [
          "в управлении правопорядка общины",
          "в Земельном центре политического просвещения",
          "в Центре по защите прав потребителей",
      ...
      {
        "question_number": 7,
        "question": "Столицей Баварии является ...",
        "options": ["Ингольштадт", "Регенсбург", "Нюрнберг", "Мюнхен"],
        "answer": "Мюнхен"
      },
      {
        "question_number": 8,
        "question": "Какая из указанных земель — Бавария?",
        "image": "/images/318.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Баварии?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в Баварии?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'berlin': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Берлин?",
      ...
      {
        "question_number": 2,
        "question": "Какой из этих районов является районом Берлина?",
        "options": ["Альтона", "Пригниц", "Панков", "Мекленбургское поозерье"],
        "answer": "Панков"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается парламент земли в Берлине?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Берлине (выборы окружного совета)?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге федеральной земли Берлин?",
        "options": [
          "синий-белый-красный",
          "бело-красный",
          "зелёный-белый-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Берлине?",
        "options": [
          "в управлении правопорядка общины",
          "в церквях",
          "в Центре по защите прав потребителей",
      ...
      {
        "question_number": 7,
        "question": "Какая федеральная земля является городом-государством?",
        "options": ["Берлин", "Саар", "Бранденбург", "Гессен"],
        "answer": "Берлин"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Берлин?",
      ...
      },
      {
        ...
        "answer": "Правящий бургомистр"
      },
      {
        "question_number": 10,
        "question": "Какого сенатора нет в Берлине?",
        "options": [
          "Сенатор по финансам",
          "Сенатор по внутренним делам",
          "Сенатор по внешним связям",
          "Сенатор по юстиции"
        ],
        "answer": "Сенатор по внешним связям"
      }
    ],
    'brandenburg': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Бранденбург?",
        "image": "/images/331.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Бранденбурге?",
        "options": ["Пригниц", "Рейн-Зиг", "Фогтланд", "Амберг-Зульцбах"],
        "answer": "Пригниц"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Бранденбурге?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
      ...
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Бранденбург?",
        "options": [
          "синий-белый-красный",
          "красно-белый",
          "зелёный-белый-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Бранденбурге?",
        "options": [
          "в церквях",
          "в управлении правопорядка общины",
          "в Земельном центре политического просвещения",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Бранденбург является ...",
        "options": ["Потсдам", "Котбус", "Бранденбург", "Франкфурт-на-Одере"],
        "answer": "Потсдам"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Бранденбург?",
        "image": "/images/338.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Бранденбурге?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Бранденбурга?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'bremen': [
      {
        "question_number": 1,
        "question":
            "Какой герб относится к вольному ганзейскому городу Бремен?",
        "image": "/images/341.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов является районом Бремена?",
        "options": ["Альтона", "Хемелинген", "Панков", "Бабельсберг"],
        "answer": "Хемелинген"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается парламент земли в Бремене?",
        "options": ["3", "4", "5", "6"],
        "answer": "4"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на выборах в парламент (Бюргершафт) в Бремене?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Бремен?",
        "options": [
          "синий-белый-красный",
          "красно-белый",
          "зелёный-белый-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Бремене?",
        "options": [
          "в управлении правопорядка общины",
          "в Земельном центре политического просвещения",
          "в церквях",
      ...
      {
        "question_number": 7,
        "question": "Что такое немецкий город-государство?",
        "options": ["Бремен", "Мюнхен", "Франкфурт", "Эрфурт"],
        "answer": "Бремен"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Бремен?",
        "image": "/images/348.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        ...
        "answer": "Президент Сената"
      },
      {
        "question_number": 10,
        "question": "Какого сенатора нет в правительстве Бремена?",
        "options": [
          "Сенатор по внешним связям",
          "Сенатор по финансам",
          "Сенатор по юстиции",
    ...
    'hamburg': [
      {
        "question_number": 1,
        "question":
            "Какой герб относится к вольному и ганзейскому городу Гамбург?",
        "image": "/images/351.png",
        "options": ["1", "2", "3", "4"],
        "answer": "2"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов является районом Гамбурга?",
        "options": [
          "Альтона",
          "Хемелинген",
          "Панков",
      ...
      {
        "question_number": 3,
        "question": "На сколько лет избирается парламент земли в Гамбурге?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Гамбурге (выборы районных собраний)?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Гамбург?",
        "options": [
          "синий-белый-красный",
          "бело-красный",
          "зелёный-бело-красный",
          "чёрно-жёлтый"
        ],
        "answer": "бело-красный"
      },
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Гамбурге?",
        "options": [
          "в управлении правопорядка общины",
          "в Центре по защите прав потребителей",
          "в церквях",
      ...
      },
      {
        "question_number": 7,
        "question": "Какая федеральная земля является городом-государством?",
        "options": ["Гамбург", "Саксония", "Бавария", "Тюрингия"],
        "answer": "Гамбург"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Гамбург?",
        "image": "/images/358.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        ...
        "answer": "Первый бургомистр"
      },
      {
        "question_number": 10,
        "question": "Какого сенатора нет в правительстве Гамбурга?",
        "options": [
          "Сенатор по юстиции",
          "Сенатор по внешним связям",
          "Сенатор по финансам",
    ...
    'hessen': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Гессен?",
        "image": "/images/361.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Гессене?",
        "options": ["Аммерланд", "Альтёттинг", "Пригниц", "Округ Майн-Таунус"],
        "answer": "Округ Майн-Таунус"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Гессене?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Гессене?",
        "options": ["14", "16", "18", "20"],
        "answer": "18"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Гессен?",
        "options": [
          "синий-белый-красный",
          "красно-белый",
          "чёрно-золотой",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Гессене?",
        "options": [
          "в Земельном центре политического просвещения",
          "в Центре по защите прав потребителей",
          "в управлении правопорядка общины",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Гессен является ...",
        "options": ["Кассель", "Дармштадт", "Франкфурт", "Висбаден"],
        "answer": "Висбаден"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Гессен?",
        "image": "/images/368.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Гессене?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Гессена?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'mecklenburg-vorpommern': [
      ...
      },
      {
        "question_number": 2,
        "question":
            "Какой из этих районов находится в Мекленбурге-Передней Померании?",
        "options": [
          "Пригниц",
          "Мекленбургское поозерье",
          "Фогтланд",
        ...
        "answer": "Мекленбургское поозерье"
      },
      {
        "question_number": 3,
        "question":
            "На сколько лет избирается ландтаг в Мекленбурге-Передней Померании?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Мекленбурге-Передней Померании?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Мекленбург-Передняя Померания?",
        "options": [
          "чёрно-красно-золотой",
          "сине-бело-жёлто-красный",
          "зелёно-бело-красный",
          "чёрно-жёлтый"
        ],
        "answer": "сине-бело-жёлто-красный"
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Мекленбурге-Передней Померании?",
        "options": [
          "в Земельном центре политического просвещения",
          "в церквях",
          "в управлении правопорядка общины",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Мекленбург-Передняя Померания является ...",
        "options": ["Грайфсвальд", "Шверин", "Росток", "Висмар"],
        "answer": "Шверин"
      },
      {
        "question_number": 8,
        "question":
            "Какая из показанных земель — это Мекленбург-Передняя Померания?",
        "image": "/images/388.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 9,
        "question":
            "Как называется глава правительства в Мекленбурге-Передней Померании?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      },
      {
        "question_number": 10,
        "question":
            "Какого министра нет в правительстве Мекленбурга-Передней Померании?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'niedersachsen': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Нижняя Саксония?",
        "image": "/images/391.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Нижней Саксонии?",
        "options": ["Аммерланд", "Рейн-Зиг", "Северная Фрисландия", "Фогтланд"],
        "answer": "Аммерланд"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Нижней Саксонии?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Нижней Саксонии?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Нижняя Саксония?",
        "options": [
          "бело-синий",
          "чёрно-красно-золотой",
          "чёрно-жёлтый",
        ...
        "answer": "чёрно-красно-золотой"
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Нижней Саксонии?",
        "options": [
          "в Земельном центре политического просвещения",
          "в управлении правопорядка общины",
          "в Центре по защите прав потребителей",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Нижняя Саксония является …",
        "options": ["Ганновер", "Брауншвейг", "Вольфсбург", "Оснабрюк"],
        "answer": "Ганновер"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Нижняя Саксония?",
        "image": "/images/398.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Нижней Саксонии?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Нижней Саксонии?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'nordrhein-westfalen': [
      ...
      },
      {
        "question_number": 2,
        "question":
            "Какой из этих районов находится в Северном Рейне – Вестфалии?",
        "options": ["Аммерланд", "Рейн-Зиг", "Северная Фрисландия", "Фогтланд"],
        "answer": "Рейн-Зиг"
      },
      {
        "question_number": 3,
        "question":
            "На сколько лет избирается ландтаг в Северном Рейне – Вестфалии?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Северном Рейне – Вестфалии?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Северный Рейн – Вестфалия?",
        "options": [
          "красно-белый",
          "зелёно-бело-красный",
          "чёрно-золотой",
        ...
        "answer": "зелёно-бело-красный"
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Северном Рейне – Вестфалии?",
        "options": [
          "в церквях",
          "в управлении правопорядка общины",
          "в Центре по защите прав потребителей",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Северный Рейн – Вестфалия является …",
        "options": ["Кёльн", "Бонн", "Дюссельдорф", "Дортмунд"],
        "answer": "Дюссельдорф"
      },
      {
        "question_number": 8,
        "question":
            "Какая из показанных земель — это Северный Рейн – Вестфалия?",
        "image": "/images/408.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 9,
        "question":
            "Как называется глава правительства в Северном Рейне – Вестфалии?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
    ...
    'rheinland-pfalz': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Рейнланд-Пфальц?",
        "image": "/images/411.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Рейнланд-Пфальце?",
        "options": ["Вестервальд", "Альтёттинг", "Эмсланд", "Пригниц"],
        "answer": "Вестервальд"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Рейнланд-Пфальце?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Рейнланд-Пфальце?",
        "options": ["14", "16", "18", "20"],
        "answer": "18"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Рейнланд-Пфальц?",
        "options": [
          "бело-красный",
          "чёрно-красно-золотой",
          "чёрно-жёлтый",
      ...
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Рейнланд-Пфальце?",
        "options": [
          "в церквях",
          "в Центре по защите прав потребителей",
          "в управлении правопорядка общины",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Рейнланд-Пфальц является …",
        "options": ["Майнц", "Кайзерслаутерн", "Людвигсхафен", "Кобленц"],
        "answer": "Майнц"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Рейнланд-Пфальц?",
        "image": "/images/418.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Рейнланд-Пфальце?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Рейнланд-Пфальца?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'saarland': [
      {
        "question_number": 1,
        "question": "Какой герб относится к федеральной земле Саар?",
        "image": "/images/371.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Сааре?",
        "options": [
          "Мекленбургское поозерье",
          "Альтёттинг",
          "Нойнкирхен",
      ...
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг Саара?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Сааре?",
        "options": ["14", "16", "18", "20"],
        "answer": "18"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Саар?",
        "options": [
          "бело-синий",
          "чёрно-красно-золотой",
          "чёрно-жёлтый",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Сааре?",
        "options": [
          "в церквях",
          "в Земельном центре политического просвещения",
          "в Центре по защите прав потребителей",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Саар является …",
        "options": ["Нойнкирхен", "Хомбург", "Саарбрюккен", "Фёльклинген"],
        "answer": "Саарбрюккен"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Саар?",
        "image": "/images/378.png",
        "options": ["1", "2", "3", "4"],
        "answer": "2"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства Саара?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Саара?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'sachsen-anhalt': [
      ...
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Саксонии-Анхальт?",
        "options": ["Аммерланд", "Альтёттинг", "Уккермарк", "Бёрде"],
        "answer": "Бёрде"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Саксонии-Анхальт?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Саксонии-Анхальт?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Саксония-Анхальт?",
        "options": [
          "сине-бело-красный",
          "жёлто-чёрный",
          "зелёно-бело-красный",
      ...
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Саксонии-Анхальт?",
        "options": [
          "в церквях",
          "в Земельном центре политического просвещения",
          "в управлении правопорядка общины",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Саксония-Анхальт является …",
        "options": ["Халле", "Дессау", "Магдебург", "Виттенберг"],
        "answer": "Магдебург"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Саксония-Анхальт?",
        "image": "/images/438.png",
        "options": ["1", "2", "3", "4"],
        "answer": "3"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Саксонии-Анхальт?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Саксонии-Анхальт?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'sachsen': [
      {
        "question_number": 1,
        "question": "Какой герб относится к свободному государству Саксония?",
        "image": "/images/421.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Саксонии?",
        "options": [
          "Фогтланд",
          "Альтёттинг",
          "Уккермарк",
      ...
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Саксонии?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Саксонии?",
        "options": ["14", "16", "18", "20"],
        "answer": "18"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Саксония?",
        "options": [
          "сине-бело-красный",
          "бело-зелёный",
          "зелёно-бело-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Саксонии?",
        "options": [
          "в Земельном центре политического просвещения",
          "в управлении правопорядка общины",
          "в церквях",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Саксония является …",
        "options": ["Лейпциг", "Дрезден", "Хемниц", "Цвиккау"],
        "answer": "Дрезден"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Саксония?",
        "image": "/images/428.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Саксонии?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Саксонии?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'schleswig-holstein': [
      ...
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Шлезвиг-Гольштейне?",
        "options": [
          "Аммерланд",
          "Мекленбургское поозерье",
          "Северная Фрисландия",
        ...
        "answer": "Северная Фрисландия"
      },
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Шлезвиг-Гольштейне?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Шлезвиг-Гольштейне?",
        "options": ["14", "16", "18", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Шлезвиг-Гольштейн?",
        "options": [
          "бело-синий",
          "сине-бело-красный",
          "бело-красный",
        ...
        "answer": "сине-бело-красный"
      },
      {
        "question_number": 6,
        "question":
            "Где можно получить информацию о политике в Шлезвиг-Гольштейне?",
        "options": [
          "в Центре по защите прав потребителей",
          "в управлении правопорядка общины",
          "у уполномоченного/уполномоченной по политическому просвещению",
          "в церквях"
        ],
        "answer":
            "у уполномоченного/уполномоченной по политическому просвещению"
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Шлезвиг-Гольштейн является …",
        "options": ["Хузум", "Фленсбург", "Любек", "Киль"],
        "answer": "Киль"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Шлезвиг-Гольштейн?",
        "image": "/images/448.png",
        "options": ["1", "2", "3", "4"],
        "answer": "1"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Шлезвиг-Гольштейне?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Шлезвиг-Гольштейна?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
    ...
    'thueringen': [
      {
        "question_number": 1,
        "question": "Какой герб относится к свободному государству Тюрингия?",
        "image": "/images/451.png",
        "options": ["1", "2", "3", "4"],
        "answer": "4"
      },
      {
        "question_number": 2,
        "question": "Какой из этих районов находится в Тюрингии?",
        "options": [
          "Аммерланд",
          "Альтёттинг",
          "Северная Фрисландия",
      ...
      {
        "question_number": 3,
        "question": "На сколько лет избирается ландтаг в Тюрингии?",
        "options": ["3", "4", "5", "6"],
        "answer": "5"
      },
      {
        "question_number": 4,
        "question":
            "С какого возраста можно голосовать на муниципальных выборах в Тюрингии?",
        "options": ["14", "18", "16", "20"],
        "answer": "16"
      },
      {
        "question_number": 5,
        "question": "Какие цвета на флаге земли Тюрингия?",
        "options": [
          "сине-бело-красный",
          "бело-красный",
          "зелёно-бело-красный",
      ...
      {
        "question_number": 6,
        "question": "Где можно получить информацию о политике в Тюрингии?",
        "options": [
          "в церквях",
          "в Центре по защите прав потребителей",
          "в Земельном центре политического просвещения",
      ...
      {
        "question_number": 7,
        "question": "Столицей земли Тюрингия является …",
        "options": ["Айзенах", "Эрфурт", "Гера", "Йена"],
        "answer": "Эрфурт"
      },
      {
        "question_number": 8,
        "question": "Какая из показанных земель — это Тюрингия?",
        "image": "/images/458.png",
        "options": ["1", "2", "3", "4"],
        "answer": "2"
      },
      {
        "question_number": 9,
        "question": "Как называется глава правительства в Тюрингии?",
        "options": [
          "Первый министр",
          "Премьер-министр",
          "Бургомистр",
      ...
      {
        "question_number": 10,
        "question": "Какого министра нет в правительстве Тюрингии?",
        "options": [
          "Министр юстиции",
          "Министр иностранных дел",
          "Министр финансов",
